...
//    var resultCount: Int
//    var results: [itemsValue]
//
//    init(from decoder: Decoder) throws {
//        let values = try decoder.container(keyedBy: CodingKeys.self)
//
//        self.resultCount = try values.decode(Int.self, forKey: CodingKeys.resultCount)
//        self.results = try values.decode([itemsValue].self, forKey: CodingKeys.results)
//    }
//}
